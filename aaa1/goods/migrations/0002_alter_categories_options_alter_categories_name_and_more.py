# Generated by Django 5.1 on 2024-11-17 14:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(decimal_places=3, default=0.0, max_digits=7, verbose_name='Цена')),
                ('discount', models.DecimalField(decimal_places=3, default=0.0, max_digits=7, verbose_name='Скидка в процентах')),
                ('quantily', models.IntegerField(default=0, verbose_name='Количество')),
